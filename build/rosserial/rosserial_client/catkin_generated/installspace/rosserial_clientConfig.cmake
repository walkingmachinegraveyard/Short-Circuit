...
if("FALSE" STREQUAL "TRUE")
  set(rosserial_client_SOURCE_PREFIX /home/wm/Short-Circuit/src/rosserial/rosserial_client)
  set(rosserial_client_DEVEL_PREFIX /home/wm/Short-Circuit/devel)
  ...
  set(rosserial_client_INSTALL_PREFIX /home/wm/Short-Circuit/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosserial_client' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wm/Short-Circuit/install/${idir}'.  Ask the maintainer 'Paul Bouchier <paul.bouchier@gmail.com>, Mike Purvis <mpurvis@clearpathrobotics.com>' to fix it.")
    endif()
