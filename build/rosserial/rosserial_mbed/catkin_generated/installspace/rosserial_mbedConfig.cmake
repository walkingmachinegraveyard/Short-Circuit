...
if("FALSE" STREQUAL "TRUE")
  set(rosserial_mbed_SOURCE_PREFIX /home/wm/Short-Circuit/src/rosserial/rosserial_mbed)
  set(rosserial_mbed_DEVEL_PREFIX /home/wm/Short-Circuit/devel)
  ...
  set(rosserial_mbed_INSTALL_PREFIX /home/wm/Short-Circuit/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosserial_mbed' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wm/Short-Circuit/install/${idir}'.  Ask the maintainer 'Gary Servin <garyservin@gmail.com>' to fix it.")
    endif()
