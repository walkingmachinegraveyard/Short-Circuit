...
if(NOT "/home/wm/Short-Circuit/src/wm_dynamic_tf/include " STREQUAL " ")
  set(wm_dynamic_tf_INCLUDE_DIRS "")
  set(_include_dirs "/home/wm/Short-Circuit/src/wm_dynamic_tf/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'wm_dynamic_tf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wm/Short-Circuit/src/wm_dynamic_tf/${idir}'.  Ask the maintainer 'wm <wm@todo.todo>' to fix it.")
    endif()
