...
echo_and_run cd "/home/wm/Short-Circuit/src/rosserial/rosserial_client"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/wm/Short-Circuit/src/rosserial/rosserial_client/setup.py" \
    build --build-base "/home/wm/Short-Circuit/build/rosserial/rosserial_client" \
    install \
    $DESTDIR_ARG \
