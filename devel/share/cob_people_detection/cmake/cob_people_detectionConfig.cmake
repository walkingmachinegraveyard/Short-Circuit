...
if("TRUE" STREQUAL "TRUE")
  set(cob_people_detection_SOURCE_PREFIX /home/wm/Short-Circuit/src/cob_people_perception/cob_people_detection)
  set(cob_people_detection_DEVEL_PREFIX /home/wm/Short-Circuit/devel)
  ...
  set(cob_people_detection_INSTALL_PREFIX /home/wm/Short-Circuit/install)
...
if(NOT "/home/wm/Short-Circuit/devel/include;/home/wm/Short-Circuit/src/cob_people_perception/cob_people_detection/ros/include;/home/wm/Short-Circuit/src/cob_people_perception/cob_people_detection/common/include;/usr/local/include/opencv;/usr/local/include;/usr/include " STREQUAL " ")
  set(cob_people_detection_INCLUDE_DIRS "")
  set(_include_dirs "/home/wm/Short-Circuit/devel/include;/home/wm/Short-Circuit/src/cob_people_perception/cob_people_detection/ros/include;/home/wm/Short-Circuit/src/cob_people_perception/cob_people_detection/common/include;/usr/local/include/opencv;/usr/local/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cob_people_detection' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wm/Short-Circuit/src/cob_people_perception/cob_people_detection/${idir}'.  Ask the maintainer 'Richard Bormann <richard.bormann@ipa.fraunhofer.de>' to fix it.")
    endif()
    _list_append_unique(cob_people_detection_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "subspace_analysis;decomposition;face_normalizer;face_recognizer_algorithms;sensor_message_gateway_nodelet;/usr/local/lib/libopencv_videostab.so.2.4.11;/usr/local/lib/libopencv_video.so.2.4.11;/usr/local/lib/libopencv_superres.so.2.4.11;/usr/local/lib/libopencv_stitching.so.2.4.11;/usr/local/lib/libopencv_photo.so.2.4.11;/usr/local/lib/libopencv_ocl.so.2.4.11;/usr/local/lib/libopencv_objdetect.so.2.4.11;/usr/local/lib/libopencv_nonfree.so.2.4.11;/usr/local/lib/libopencv_ml.so.2.4.11;/usr/local/lib/libopencv_legacy.so.2.4.11;/usr/local/lib/libopencv_imgproc.so.2.4.11;/usr/local/lib/libopencv_highgui.so.2.4.11;/usr/local/lib/libopencv_gpu.so.2.4.11;/usr/local/lib/libopencv_flann.so.2.4.11;/usr/local/lib/libopencv_features2d.so.2.4.11;/usr/local/lib/libopencv_core.so.2.4.11;/usr/local/lib/libopencv_contrib.so.2.4.11;/usr/local/lib/libopencv_calib3d.so.2.4.11;/usr/lib/x86_64-linux-gnu/libboost_signals.so;/usr/lib/x86_64-linux-gnu/libboost_system.so;/usr/lib/x86_64-linux-gnu/libboost_filesystem.so")
...
set(depends "roscpp;std_msgs;std_srvs;actionlib;sensor_msgs;actionlib_msgs;geometry_msgs;stereo_msgs;image_transport;image_geometry;image_view;tf;nodelet;dynamic_reconfigure;pcl_ros;cv_bridge;cob_image_flip;cob_vision_utils;cob_perception_msgs;message_runtime")
